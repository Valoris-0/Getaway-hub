...
function getDistance(from, to) {
  ...
  for (const route of allRoutes) {
    ...
    if (
      (start.includes(from) || from.includes(start)) &&
  ...
  const accommodations = [
    {
      ...
      rating: 5,
      image:
        "https://images.unsplash.com/photo-1586375300773-8384e3e4916f?q=80&w=2070",
      description:
        "Luxury eco-resort nestled in the heart of Costa Rica's pristine rainforest.",
    },
    {
      ...
      rating: 5,
      image:
        "https://images.unsplash.com/photo-1502786129293-79981df4e689?q=80&w=2070",
      description:
        "Sustainable mountain retreat nestled in the stunning Dolomites with panoramic alpine views.",
    },
    {
      ...
      rating: 5,
      image:
        "https://images.unsplash.com/photo-1439066615861-d1af74d74000?q=80&w=2070",
      description:
        "Overwater villas powered by solar energy with coral reef conservation programs",
    },
    {
      ...
      rating: 4,
      image:
        "https://images.unsplash.com/photo-1520681279154-51b3fb4ea0f7?q=80&w=2070",
      description:
        "Sustainable Arctic retreat with spectacular views of the Northern Lights",
    },
    {
      ...
      rating: 5,
      image:
        "https://images.unsplash.com/photo-1503899036084-c55cdd92da26?q=80&w=2070",
      description:
        "Traditional Japanese temple stay with meditation gardens and sustainable practices",
    },
    {
      ...
      description:
        "Immersive rainforest experience supporting local conservation efforts",
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1596394516093-501ba68a0ba6?q=80&w=2070",
      description:
        "Luxurious eco-resort surrounded by ancient rainforest, offering wildlife conservation experiences and sustainable living practices",
    },
    {
      ...
      rating: 5,
      image:
        "https://images.unsplash.com/photo-1511316695145-4992006ffddb?q=80&w=2070",
      description:
        "Beachfront resort focused on marine conservation and reef protection",
    },
    {
      ...
      description:
        "Sustainable safari lodge supporting gorilla conservation and local communities",
    },
  ];
...
function createEnhancedAccommodationCard(acc) {
  ...
  acc.details = acc.details || {
    sustainability:
      "This eco-friendly accommodation implements various sustainable practices to minimize environmental impact.",
    location:
      "Situated in a pristine natural environment, carefully chosen to preserve local ecosystems.",
    activities:
      "Offers various eco-friendly activities and educational programs about sustainable living.",
  };
  ...
  const tips = [
    {
      ...
      description:
        "Pack reusable items like water bottles, bags, and utensils to minimize waste during your journey.",
    ...
    },
    {
      ...
      description:
        "Use public transportation, bike rentals, or walk to reduce your carbon footprint while exploring.",
      category: "Transport",
    },
    {
      icon: "🏘️",
      ...
      description:
        "Choose locally-owned accommodations and restaurants to support the local economy.",
      category: "Community",
    },
...
function initializeDestinationPage() {
  ...
  filterBtnsParent.addEventListener("click", (e) => {
    const btn = e.target;
    if (btn.getAttribute("data-filter") === null) return;
